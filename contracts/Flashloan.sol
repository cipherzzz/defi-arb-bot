...
} from '@studydefi/money-legos/kyber/contracts/KyberNetworkProxy.sol';
    ...
    function callFunction(
        ...
        if (arbInfo.direction == Direction.KyberToUniswap) {
            ...
            (uint256 expectedRate, ) =
                kyber.getExpectedRate(dai, IERC20(KYBER_ETH_ADDRESS), balanceDai);
            ...
            //Sell ETH on Kyber
            (uint256 expectedRate, ) =
                kyber.getExpectedRate(IERC20(KYBER_ETH_ADDRESS), dai, address(this).balance);
